...
{
    public class Seiran_Plushie_Tile : PlushieTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Seiran Plushie");
            AddMapEntry(new Color(140, 167, 212), name);

            plushieItem = ItemType<Seiran_Plushie_Item>();
        }
    }
}