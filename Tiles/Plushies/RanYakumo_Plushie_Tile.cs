...
{
    public class RanYakumo_Plushie_Tile : PlushieTile
    {
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Ran Yakumo Plushie");
            AddMapEntry(new Color(107, 58, 0), name);

            plushieItem = ItemType<RanYakumo_Plushie_Item>();
        }
    }
}