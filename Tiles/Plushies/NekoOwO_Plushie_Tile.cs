...
{
    public class NekoOwO_Plushie_Tile : PlushieTile
    {
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Neko OwO Plushie");
            AddMapEntry(new Color(34, 34, 34), name);

            plushieItem = ItemType<NekoOwO_Plushie_Item>();
        }
    }
}