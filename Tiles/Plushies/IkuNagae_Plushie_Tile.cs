...
{
    public class IkuNagae_Plushie_Tile : PlushieTile
    {
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Iku Nagae Plushie");
            AddMapEntry(new Color(21, 14, 81), name);

            plushieItem = ItemType<IkuNagae_Plushie_Item>();
        }
    }
}