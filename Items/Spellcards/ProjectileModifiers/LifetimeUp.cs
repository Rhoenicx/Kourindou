...
{
    public class LifetimeUp : CardItem
    {
        public override void SetStaticDefaults()
        {
            // When loading this card, register it!
            RegisterCardItem((byte)Groups.ProjectileModifier, (byte)ProjectileModifier.LifetimeUp, Type);
            
            // DisplayName.SetDefault("Lifetime Up");
            // Tooltip.SetDefault("");
        }
        ...
        public override void SetCardDefaults()
        {
            ...
            Spell = (byte)ProjectileModifier.LifetimeUp;
            Variant = 0;
            Amount = 1f;
            Value = 1.25f;
            AddUseTime = 0;
        ...
        {
            proj.LifeTime = (int)(proj.LifeTime * GetValue());
        }
    }
}
