...
{
    public class Gravity : CardItem
    {
        public override void SetStaticDefaults()
        {
            // When loading this card, register it!
            RegisterCardItem((byte)Groups.ProjectileModifier, (byte)ProjectileModifier.Gravity, Type);
        ...
        public override void SetCardDefaults()
        {
            ...
            Spell = (byte)ProjectileModifier.Gravity;
            Variant = 0;
            Amount = 1f;
            Value = 8f;
            AddUseTime = 0;
        ...
        {
            proj.Gravity = Math.Abs(proj.Gravity);
            proj.Gravity += GetValue();
        }
    }
}
