...
{
    public class VectorReversal : CardItem
    {
        public override void SetStaticDefaults()
        {
            // When loading this card, register it!
            RegisterCardItem((byte)Groups.ProjectileModifier, (byte)ProjectileModifier.VectorReversal, Type);
            
            // DisplayName.SetDefault("Vector Reversal");
            // Tooltip.SetDefault("");
        }
        ...
        public override void SetCardDefaults()
        {
            ...
            Spell = (byte)ProjectileModifier.VectorReversal;
            Variant = 0;
            Amount = 1f;
            AddUseTime = 0;
            AddCooldown = 0;
