...
{
    public class PenetrationAll : CardItem
    {
        public override void SetStaticDefaults()
        {
            // When loading this card, register it!
            RegisterCardItem((byte)Groups.ProjectileModifier, (byte)ProjectileModifier.PenetrationAll, Type);
            
            // DisplayName.SetDefault("Penetration All");
            // Tooltip.SetDefault("");
        }
        ...
        public override void SetCardDefaults()
        {
            ...
            Spell = (byte)ProjectileModifier.PenetrationAll;
            Variant = 0;
            Amount = 1f;
            AddUseTime = 0;
            AddCooldown = 0;
