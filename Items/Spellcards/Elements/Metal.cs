...
{
    public class Metal : CardItem
    {
        public override void SetStaticDefaults()
        {
            // When loading this card, register it!
            RegisterCardItem((byte)Groups.Element, (byte)Element.Metal, Type);
            
            // DisplayName.SetDefault("Metal");
            // Tooltip.SetDefault("");
        }
