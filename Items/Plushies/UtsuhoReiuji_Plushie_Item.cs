...
namespace Kourindou.Items.Plushies
{
    public class UtsuhoReiuji_Plushie_Item : PlushieItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = TileType<UtsuhoReiuji_Plushie_Tile>();
        ...
        public override bool UseItem(Player player)
        {
            ...
            {
                shootSpeed = 8f;
                projectileType = ProjectileType<UtsuhoReiuji_Plushie_Projectile>();
            }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemType<OrangeFabric>(), 1);
