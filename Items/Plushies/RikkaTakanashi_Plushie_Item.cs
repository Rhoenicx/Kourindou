...
{
    public class RikkaTakanashi_Plushie_Item : PlushieItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<RikkaTakanashi_Plushie_Tile>();
        ...
        public override bool? UseItem(Player player)
        {
            ...
            {
                shootSpeed = 8f;
                projectileType = ProjectileType<RikkaTakanashi_Plushie_Projectile>();
            }
