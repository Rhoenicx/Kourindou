...
{
    public class Gensokyo_Metal_Fairy_Plushie_Item : PlushieItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<Gensokyo_Metal_Fairy_Plushie_Tile>();
        ...
        public override bool? UseItem(Player player)
        {
            ...
            {
                shootSpeed = 8f;
                projectileType = ProjectileType<Gensokyo_Metal_Fairy_Plushie_Projectile>();
            }
        ...
        public override void PlushieUpdateEquips(Player player, int amountEquipped)
        {
            ...
            {
                player.npcTypeNoAggro[Kourindou.Gensokyo_Fairy_Metal_Type] = true;
            }
        }
        ...
        public override bool PlushieCanBeHitByNPC(Player myPlayer, NPC npc, ref int cooldownSlot, int amountEquipped)
        {
            if (Kourindou.GensokyoLoaded)
            {
                return npc.type != Kourindou.Gensokyo_Fairy_Metal_Type;
            }
