...
namespace Kourindou.Items.Plushies
{
    public class ChimataTenkyuu_Plushie_Item : PlushieItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = TileType<ChimataTenkyuu_Plushie_Tile>();
        ...
        public override bool UseItem(Player player)
        {
            ...
            {
                shootSpeed = 8f;
                projectileType = ProjectileType<ChimataTenkyuu_Plushie_Projectile>();
            }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemType<RainbowFabric>(), 3);
