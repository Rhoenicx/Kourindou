...
{
    public class KogasaTatara_Plushie_Item : PlushieItem
    {
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<KogasaTatara_Plushie_Tile>();
        ...
        public override bool? UseItem(Player player)
        {
            ...
            {
                shootSpeed = 8f;
                projectileType = ProjectileType<KogasaTatara_Plushie_Projectile>();
            }
